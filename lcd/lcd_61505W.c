...
* File Name          : lcd_61505W.c
* Author             :  
* Version            :  
* Date               : 02/27/2014
* Description        : This file provides all the lcd 61505W EMI firmware functions.
***************************************************************************/
//===================================================================
//                                                     	            |
//                       INCLUDE FILES                              |
...
const struct emimode emi_61505W ={
	.red_width = 5,
	.green_width = 6,
	.blue_width = 5,
...
void lcd_init(void) 
{
	deg_Printf("lcd_init mcu 61505W \n");
	blcd_FrameEnd_Flag = 0;	
	blcd_writeback_Flag = 0;

	PIN_CONF()						//IO down

	lcd_emi_timing_init(emi_61505W);
...
u32 lcd_get_w()
{
	return emi_61505W.pwidth+1;
}

u32 lcd_get_h()
{
	return emi_61505W.pheight+1;
}

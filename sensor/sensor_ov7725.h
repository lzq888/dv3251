...
* File Name          : sensor_ov7725.h
* Author             : pengtao_zhang
* Version            : V0829a
* Date               : 08/29/2013
* Description        : sensor ov7725 HEADER FILE.
***************************************************************************/
#ifndef _SENSOR_OV7725_H_
#define _SENSOR_OV7725_H_
/*
...
*/
#define OV7725_I2C_BAUD        (40000)         //400K
#define OV7725_I2C_READ_ADDR   (0x43)
#define OV7725_I2C_WRITE_ADDR  (0x42)
#define OV7725_CHIP_ID_ADDR    (0x0a)

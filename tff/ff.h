...
FRESULT f_unlink_removeDir(const TCHAR* path,FATFS* pDelFS);
FRESULT f_unlink_removeChain(FATFS* pDelFS,	FATFS* pWorkFs,DWORD *pDelclst,DWORD mode);
...
FRESULT f_merge(FIL* fp1,FIL* fp2);
DWORD clust2sect (FATFS* fs,DWORD clst);
FRESULT f_bound(FIL* fp1,FIL* fp2);
FRESULT f_bound_init();

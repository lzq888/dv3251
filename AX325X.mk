...
$(IntermediateDirectory)/fat_api_fat.c$(ObjectSuffix): fat_api/fat.c $(IntermediateDirectory)/fat_api_fat.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/work1/DV3251_UNOS_sdk_release_v1.3/release/fat_api/fat.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/fat_api_fat.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/fat_api_fat.c$(DependSuffix): fat_api/fat.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/fat_api_fat.c$(ObjectSuffix) -MF$(IntermediateDirectory)/fat_api_fat.c$(DependSuffix) -MM "fat_api/fat.c"

$(IntermediateDirectory)/fat_api_fat.c$(PreprocessSuffix): fat_api/fat.c
	@$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/fat_api_fat.c$(PreprocessSuffix) "fat_api/fat.c"
